...
function ProfileDetail() {
  ...
  console.log(user?.likedPosts?.length, user?.bookmarkedPosts?.length);
    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="bg-secondary-0 rounded-xl flex flex-col borser border-secondary-100  max-w-xl p-2">
          ...
          <div
            className=" border-t py-5 border-secondary-300
 gap-x-3 items-center justify-between flex"
          ...
          <div className=" py-5 gap-x-3 items-center justify-between flex">
            <TextField
              ...
              className="textField__input"
              type="text"
              value={toPersianDigits(Number(user?.likedPosts?.length))}
            />
            <TextField
              disabled={true}
              ...
              className="textField__input"
              type="text"
              value={toPersianDigits(Number(user?.bookmarkedPosts?.length))}
            />
          </div>
        </div>
      </div>
